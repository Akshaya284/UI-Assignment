document.addEventListener("DOMContentLoaded", function() {
    ...
    const products = [
        {
            imgSrc: "https://png.pngtree.com/png-vector/20230902/ourmid/pngtree-white-t-shirt-mockup-realistic-t-shirt-png-image_9906363.png",
            altText: "Shop Women",
            title: "Shop Women",
            description: "Lorem ipsum dolor sit amet"
        },
        {
            imgSrc: "https://5.imimg.com/data5/RS/TD/MY-8637222/mens-designer-jacket-500x500.png",
            altText: "Shop Men",
            title: "Shop Men",
            description: "Lorem ipsum dolor sit amet"
        },
        ...
        {
            imgSrc: "https://images.samsung.com/is/image/samsung/in-full-hd-tv-te50fa-ua43te50fakxxl-frontblack-231881877?$650_519_PNG$",
            altText: "Electronics",
            title: "Electronics",
            description: "Lorem ipsum dolor sit amet"
        }
    ];
    const productSection = document.getElementById("homePro");
    if (productSection) products.forEach((product)=>{
        console.log("Creating product:", product); // Debugging log
        const productDiv = document.createElement("div");
        productDiv.className = "productHome";
    ...
    else console.error("Product section not found or not visible"); // Error log
});
